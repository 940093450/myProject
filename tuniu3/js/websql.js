...
window.addEventListener("load",function(){
    ...
    name.addEventListener("keyup",function(){
        ...
        if (name.value!=0){
            ...
            name_ts.style.background="url('../tuniu3/regimg/4.png') 0 1px no-repeat";
        }else {
            name_ts.innerHTML="用户名不能为空";
            name_ts.style.background="url('../tuniu3/login/3.png') 0 1px no-repeat";
    ...
    mobile.addEventListener("keyup",function(){
        ...
        if (call_validate(mobile.value)&&mobile.value!=0){
            ...
            mobile_ts.style.background="url('../tuniu3/regimg/4.png') 0 1px no-repeat";

        }else {
            mobile_ts.innerHTML="手机格式不正确";
            mobile_ts.style.background="url('../tuniu3/login/3.png') 0 1px no-repeat";
